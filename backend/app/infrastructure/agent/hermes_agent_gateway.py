"""HermesAgent AgentGateway adapter — stub.

TODO(issue#6): implement the real HermesAgent transport (per ADR-0004, bridge
its message schema to the design-spec §11 AgentReply shape). For now this is a
...
_STUB_NOTICE = "[HermesAgent stub] not yet implemented (TODO issue#6)"


class HermesAgentGateway(AgentGateway):
    """Placeholder adapter for the HermesAgent backend."""
